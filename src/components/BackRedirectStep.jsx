...
export default function BackRedirectStep({ onBackToQuiz }) {
  ...
  return (
    <div className="relative min-h-dvh bg-gradient-to-b from-[#240828] via-[#1A041E] to-[#120215] py-5 px-3.5 sm:px-6 flex flex-col items-center font-body text-white">
      ...
      <div className="w-full max-w-xl mx-auto space-y-4">
        ...
        <div className="bg-gradient-to-r from-[#1A041E] via-[#FF2A85] to-[#FF007F] text-white rounded-2xl p-3 px-4 shadow-lg flex items-center justify-between gap-2 border border-white/20 animate-pulse">
        ...
        <div className="bg-[#240828] rounded-[28px] p-5 sm:p-7 shadow-2xl border border-[#4C1450] space-y-5 text-center quiz-card animate-pop">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl sm:text-3xl font-black text-white leading-tight font-heading">
              ¡Espera! No Te Vayas Sin Ver Todo el Valor de Tu Plan 🍑
            </h1>
            <p className="text-xs sm:text-sm text-[#D4BCD0] font-medium leading-relaxed max-w-lg mx-auto">
          ...
          <div className="space-y-3 text-left">
            <div className="flex items-center justify-between px-1">
              <span className="text-xs font-black text-white uppercase tracking-wider font-heading flex items-center gap-1.5">
                <Sparkles className="w-4 h-4 text-[#FF2A85]" />
                <span>Todo lo que incluye tu acceso VIP hoy:</span>
              </span>
              <span className="text-[11px] font-black text-[#10B981] bg-[#063725] px-2 py-0.5 rounded-full border border-[#10B981]/30">
                100% Desbloqueado
              </span>
            </div>

            {/* Value Item 1 */}
            <div className="bg-[#1A041E] p-3.5 rounded-2xl border border-[#4C1450] flex items-start gap-3 shadow-2xs">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-1">
                  <h3 className="text-xs sm:text-sm font-black text-white font-heading">
                    Protocolo Glúteos Brasileños 28D (PGB)
                  </h3>
                  <span className="text-[11px] font-bold text-[#A890A4] line-through shrink-0">$97.00</span>
                </div>
                <p className="text-[11px] sm:text-xs text-[#D4BCD0] font-medium mt-0.5">
            ...
            <div className="bg-[#1A041E] p-3.5 rounded-2xl border border-[#4C1450] flex items-start gap-3 shadow-2xs">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-1">
                  ...
                  <span className="text-[11px] font-bold text-[#A890A4] line-through shrink-0">$47.00</span>
                </div>
                <p className="text-[11px] sm:text-xs text-[#D4BCD0] font-medium mt-0.5">
            ...
            <div className="bg-[#1A041E] p-3.5 rounded-2xl border border-[#4C1450] flex items-start gap-3 shadow-2xs">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-1">
                  ...
                  <span className="text-[11px] font-bold text-[#A890A4] line-through shrink-0">$37.00</span>
                </div>
                <p className="text-[11px] sm:text-xs text-[#D4BCD0] font-medium mt-0.5">
            ...
            <div className="bg-[#1A041E] p-3.5 rounded-2xl border-2 border-[#FFE600] flex items-start gap-3 shadow-2xs">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-1">
                  <h3 className="text-xs sm:text-sm font-black text-white font-heading flex items-center gap-1">
                    <span>🎁 BÔNUS: SOS Celulite & Efeito Push-Up 14D</span>
                  </h3>
                  <span className="text-[11px] font-bold text-[#A890A4] line-through shrink-0">$29.00</span>
                </div>
                <p className="text-[11px] sm:text-xs text-[#D4BCD0] font-medium mt-0.5">
            ...
            <div className="bg-[#1A041E] p-3.5 rounded-2xl border-2 border-[#FFE600] flex items-start gap-3 shadow-2xs">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-1">
                  ...
                  <span className="text-[11px] font-bold text-[#A890A4] line-through shrink-0">$19.00</span>
                </div>
                <p className="text-[11px] sm:text-xs text-[#D4BCD0] font-medium mt-0.5">
            ...
            <div className="bg-[#1A041E] p-3.5 rounded-2xl border border-[#4C1450] flex items-start gap-3 shadow-2xs">
              <div className="w-10 h-10 rounded-xl bg-[#340E39] text-[#FFE600] flex items-center justify-center font-black text-lg shrink-0 shadow-xs border border-[#FFE600]/40">
                ★
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-1">
                  ...
                  <span className="text-[11px] font-bold text-[#A890A4] line-through shrink-0">$67.00</span>
                </div>
                <p className="text-[11px] sm:text-xs text-[#D4BCD0] font-medium mt-0.5">
          ...
          <div className="bg-gradient-to-br from-[#1A041E] via-[#2E0832] to-[#140217] text-white rounded-[24px] p-4.5 sm:p-6 text-left space-y-3.5 shadow-lg border border-[#4C1450]">
            <div className="flex items-center justify-between border-b border-white/15 pb-2.5">
              <span className="text-xs font-black tracking-wider uppercase text-[#FFE600] font-heading">
            ...
            <div className="bg-[#240828] text-white border border-[#4C1450] rounded-2xl p-4 text-center space-y-1 shadow-md">
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                <span className="text-xs text-[#D4BCD0] font-bold">
                  (Pago Único • Sin Mensualidades)
                </span>
              </div>
              <p className="text-[10px] text-[#A890A4] font-medium">
          ...
          <div className="space-y-2.5 pt-1">
            <a
              ...
              className="w-full py-4.5 sm:py-5 px-6 rounded-[22px] bg-gradient-to-r from-[#FF2A85] via-[#FF007F] to-[#10B981] hover:brightness-110 text-white font-black text-base sm:text-lg shadow-[0_12px_28px_rgba(255,42,133,0.45)] flex items-center justify-center gap-2 active:scale-[0.98] transition-all cursor-pointer font-heading uppercase tracking-wide group animate-pulse"
            >
            ...
            {/* Guarantee Callout */}
            <div className="flex items-center justify-center gap-1.5 text-xs text-[#10B981] bg-[#063725] border border-[#10B981]/40 py-2 px-3 rounded-xl font-black font-heading">
          ...
          <div className="space-y-3 pt-3 text-left border-t border-[#4C1450]">
            <span className="text-xs font-black text-white uppercase tracking-wider font-heading block">
              Resultados de alumnas que empezaron con el mismo plan:
            </span>

            <div className="grid grid-cols-2 gap-2.5">
              {(BEFORE_AFTER_CASES || []).slice(0, 2).map((item) => (
                <div key={`case-${item.name}`} className="bg-[#1A041E] rounded-2xl p-2.5 border border-[#4C1450] space-y-1.5 text-center">
                  <div className="w-full aspect-[4/3] rounded-xl overflow-hidden bg-[#240828]">
                    <img 
                      src={item.image} 
                      alt={item.name}
                  ...
                  <div>
                    <span className="text-[11px] font-black text-white block font-heading">{item.name}</span>
          ...
          <div className="bg-[#1A041E] rounded-2xl p-4 border border-[#FFE600] text-left flex items-start gap-3 shadow-xs">
            <Award className="w-10 h-10 text-[#FF2A85] shrink-0 mt-0.5" />
            <div className="space-y-1">
              <h4 className="text-xs sm:text-sm font-black text-white font-heading">
                Garantía Blindada de Satisfacción Total (30 Días)
              </h4>
              <p className="text-[11px] text-[#D4BCD0] leading-relaxed">
          ...
          <div className="pt-2 border-t border-[#4C1450]">
            <button
              type="button"
              onClick={handleOpenDownsell}
              className="text-xs font-bold text-[#A890A4] hover:text-[#FF2A85] underline transition-colors cursor-pointer block mx-auto py-1"
            >
          ...
          {onBackToQuiz && (
            <div className="pt-0.5">
              <button
                ...
                className="text-[11px] font-medium text-[#A890A4] hover:text-white transition-colors cursor-pointer"
              >
      ...
      {showDownsellModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-md animate-fade-in">
          <div className="relative w-full max-w-md bg-[#240828] rounded-[28px] p-5 sm:p-6 shadow-2xl border-2 border-[#FF2A85] text-center space-y-4 animate-pop text-white">
            
            {/* Close Button */}
            <button
              type="button"
              onClick={() => setShowDownsellModal(false)}
              className="absolute top-3.5 right-3.5 w-8 h-8 rounded-full bg-[#1A041E] text-[#A890A4] hover:text-white hover:bg-[#340E39] flex items-center justify-center transition-all cursor-pointer border border-[#4C1450]"
            ...
            <div className="bg-[#1A041E] rounded-2xl p-4 border-2 border-dashed border-[#FF2A85] space-y-1.5 shadow-inner">
              <div className="flex items-center justify-center gap-2">
                <span className="text-xs font-bold text-[#A890A4] line-through">
              ...
              <span className="text-[10px] font-black text-[#FFE600] block pt-0.5">
                ⚡ Te llevas TODO el plan completo por solo $5.90 hoy.
              </span>
            </div>

            {/* Fast Benefit Checklist */}
            <div className="bg-[#1A041E] rounded-xl p-3 text-left space-y-1.5 text-xs font-medium text-white border border-[#4C1450]">
              <div className="flex items-center gap-2">
            ...
            <div className="space-y-2 pt-1">
              <a
                ...
                className="w-full py-4 px-5 rounded-[20px] bg-gradient-to-r from-[#FF2A85] via-[#FF007F] to-[#10B981] hover:brightness-110 text-white font-black text-sm sm:text-base shadow-[0_10px_24px_rgba(255,42,133,0.45)] flex items-center justify-center gap-2 active:scale-[0.98] transition-all cursor-pointer font-heading uppercase tracking-wide group animate-pulse"
              >
              ...
              <button
                type="button"
                onClick={() => setShowDownsellModal(false)}
                className="text-[11px] font-bold text-[#A890A4] hover:text-red-400 transition-colors cursor-pointer block mx-auto pt-1"
              >
