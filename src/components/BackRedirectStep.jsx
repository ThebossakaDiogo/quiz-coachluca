...
export default function BackRedirectStep({ onBackToQuiz }) {
  ...
  return (
    <div className="relative min-h-dvh bg-gradient-to-b from-[#FFF2D6] via-[#FFF5F9] to-[#FFF9F2] py-5 px-3.5 sm:px-6 flex flex-col items-center font-body text-[#2B0B2E]">
      ...
      <div className="w-full max-w-xl mx-auto space-y-4">
        ...
        <div className="bg-gradient-to-r from-[#2B0B2E] via-[#FF2A85] to-[#FF007F] text-white rounded-2xl p-3 px-4 shadow-lg flex items-center justify-between gap-2 border border-white/20 animate-pulse">
          ...
          <div className="flex items-center gap-1.5 bg-black/30 backdrop-blur-md px-2.5 py-1 rounded-full font-mono text-xs font-black text-[#FFE600]">
        ...
        <div className="bg-white rounded-[28px] p-5 sm:p-7 shadow-xl border border-[#FDE2EE] space-y-5 text-center quiz-card animate-pop">
          ...
          <div className="inline-flex items-center gap-1.5 bg-[#FFFBE6] text-[#2B0B2E] border-2 border-[#FFE600] text-[10px] sm:text-[11px] font-black uppercase tracking-wider px-3.5 py-1 rounded-full shadow-[2px_2px_0px_#FF2A85] font-heading">
            <Gift className="w-3.5 h-3.5 text-[#FF2A85]" />
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-[#6C586B] font-medium leading-relaxed max-w-lg mx-auto">
          ...
          <div className="space-y-3 text-left">
            <div className="flex items-center justify-between px-1">
              ...
              <span className="text-[11px] font-black text-[#10B981] bg-[#ECFDF5] px-2 py-0.5 rounded-full border border-[#10B981]/20">
                100% Desbloqueado
              </span>
            </div>

            {/* Value Item 1 */}
            <div className="bg-gradient-to-r from-[#FFF4FA] to-white p-3.5 rounded-2xl border border-[#FDE2EE] flex items-start gap-3 shadow-2xs">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] sm:text-xs text-[#6C586B] font-medium mt-0.5">
            ...
            {/* Value Item 2 */}
            <div className="bg-gradient-to-r from-[#FFF4FA] to-white p-3.5 rounded-2xl border border-[#FDE2EE] flex items-start gap-3 shadow-2xs">
              <div className="w-10 h-10 rounded-xl bg-[#FFB800] text-[#2B0B2E] flex items-center justify-center font-black text-lg shrink-0 shadow-xs">
                2
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-1">
            ...
            <div className="bg-gradient-to-r from-[#FFFBE6] to-[#FFF4FA] p-3.5 rounded-2xl border-2 border-[#FFE600] flex items-start gap-3 shadow-2xs">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#FFE600] to-[#FFB800] text-[#2B0B2E] flex items-center justify-center font-black text-xs shrink-0 shadow-xs uppercase font-heading">
                GRATIS
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-1">
            ...
            <div className="bg-gradient-to-r from-[#FFF4FA] to-white p-3.5 rounded-2xl border border-[#FDE2EE] flex items-start gap-3 shadow-2xs">
              <div className="w-10 h-10 rounded-xl bg-[#2B0B2E] text-white flex items-center justify-center font-black text-lg shrink-0 shadow-xs">
                ★
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-1">
          ...
          <div className="bg-gradient-to-br from-[#2B0B2E] to-[#1F0721] text-white rounded-[24px] p-4.5 sm:p-6 text-left space-y-3.5 shadow-lg border border-[#FFE600]/30">
            ...
            <div className="bg-white text-[#2B0B2E] rounded-2xl p-4 text-center space-y-1 shadow-md">
          ...
          <div className="space-y-2.5 pt-1">
            <a
              ...
              className="w-full py-4.5 sm:py-5 px-6 rounded-[22px] bg-gradient-to-r from-[#FF2A85] via-[#FF007F] to-[#10B981] hover:brightness-105 text-white font-black text-base sm:text-lg shadow-[0_12px_28px_rgba(255,42,133,0.38)] flex items-center justify-center gap-2 active:scale-[0.98] transition-all cursor-pointer font-heading uppercase tracking-wide group animate-pulse"
            >
            ...
            {/* Guarantee Callout */}
            <div className="flex items-center justify-center gap-1.5 text-xs text-[#065F46] bg-[#ECFDF5] border border-[#10B981]/25 py-2 px-3 rounded-xl font-black font-heading">
          ...
          <div className="space-y-3 pt-3 text-left border-t border-[#FDE2EE]">
            ...
            <div className="grid grid-cols-2 gap-2.5">
              {(BEFORE_AFTER_CASES || []).slice(0, 2).map((item) => (
                <div key={`case-${item.name}`} className="bg-[#FFF4FA] rounded-2xl p-2.5 border border-[#FDE2EE] space-y-1.5 text-center">
                  ...
                  <div>
                    <span className="text-[11px] font-black text-[#2B0B2E] block font-heading">{item.name}</span>
          ...
          <div className="bg-gradient-to-b from-[#FFF4FA] to-[#FFFBE6] rounded-2xl p-4 border border-[#FFE600] text-left flex items-start gap-3 shadow-xs">
            <Award className="w-10 h-10 text-[#FF2A85] shrink-0 mt-0.5" />
            <div className="space-y-1">
              <h4 className="text-xs sm:text-sm font-black text-[#2B0B2E] font-heading">
                Garantía Blindada de Satisfacción Total (30 Días)
              </h4>
              <p className="text-[11px] text-[#6C586B] leading-relaxed">
          ...
          <div className="pt-2 border-t border-[#FDE2EE]">
            <button
              type="button"
              onClick={handleOpenDownsell}
              className="text-xs font-bold text-[#968493] hover:text-[#FF2A85] underline transition-colors cursor-pointer block mx-auto py-1"
            >
          ...
          {onBackToQuiz && (
            <div className="pt-0.5">
              <button
                ...
                className="text-[11px] font-medium text-[#968493] hover:text-[#2B0B2E] transition-colors cursor-pointer"
              >
      ...
      {showDownsellModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/75 backdrop-blur-md animate-fade-in">
          <div className="relative w-full max-w-md bg-white rounded-[28px] p-5 sm:p-6 shadow-2xl border-2 border-[#FF2A85] text-center space-y-4 animate-pop">
            
            {/* Close Button */}
            <button
              type="button"
              onClick={() => setShowDownsellModal(false)}
              className="absolute top-3.5 right-3.5 w-8 h-8 rounded-full bg-[#FFF4FA] text-[#968493] hover:text-[#2B0B2E] hover:bg-[#FDE2EE] flex items-center justify-center transition-all cursor-pointer"
            ...
            <div className="bg-gradient-to-br from-[#FFFBE6] via-[#FFF4FA] to-[#FFFBE6] rounded-2xl p-4 border-2 border-dashed border-[#FF2A85] space-y-1.5 shadow-inner">
              <div className="flex items-center justify-center gap-2">
              ...
              <span className="text-[10px] font-black text-[#2B0B2E] block pt-0.5">
                ⚡ Te llevas TODO el plan completo por solo $5.90 hoy.
              </span>
            </div>

            {/* Fast Benefit Checklist */}
            <div className="bg-[#FFF4FA] rounded-xl p-3 text-left space-y-1.5 text-xs font-medium text-[#2B0B2E]">
              <div className="flex items-center gap-2">
            ...
            <div className="space-y-2 pt-1">
              <a
                ...
                className="w-full py-4 px-5 rounded-[20px] bg-gradient-to-r from-[#FF2A85] via-[#FF007F] to-[#10B981] hover:brightness-105 text-white font-black text-sm sm:text-base shadow-[0_10px_24px_rgba(255,42,133,0.38)] flex items-center justify-center gap-2 active:scale-[0.98] transition-all cursor-pointer font-heading uppercase tracking-wide group animate-pulse"
              >
