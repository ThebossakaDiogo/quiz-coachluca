...
import { ChevronRight, CheckCircle2, Sparkles, Star, ArrowLeft, Trophy, Flame, Award, Activity } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-lg mx-auto space-y-4">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl border border-slate-100 animate-pop space-y-6 text-center">
          ...
          <div className="space-y-1.5">
            <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#15803D] bg-emerald-50 px-3 py-1 rounded-full border border-emerald-200">
              <Trophy className="w-3.5 h-3.5 text-[#16A34A]" />
              Creador del Método Glúteos Brasileños 🇧🇷
            </span>
          ...
          <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200 space-y-3 text-left">
            <div className="flex items-center justify-between gap-2">
              ...
              <span className="bg-emerald-100 text-[#15803D] text-xs font-semibold px-3 py-1 rounded-full">
                Verificado ✓
              </span>
            </div>
