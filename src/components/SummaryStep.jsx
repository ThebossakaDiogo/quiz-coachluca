  ...
  return (
    <div className="min-h-dvh bg-gradient-to-b from-[#240828] via-[#1A041E] to-[#120215] py-6 px-3.5 sm:px-6 flex flex-col justify-center items-center font-body text-white">
      ...
      <div className="w-full max-w-lg mx-auto space-y-3.5">
        ...
        {/* MAIN CARD CONTAINER */}
        <div className="bg-[#240828] rounded-[26px] p-5 sm:p-7 shadow-2xl border border-[#4C1450] animate-pop space-y-5 text-center quiz-card">
          
          {/* LIVE DIAGNOSTIC LOADER HEADER */}
          <div className="bg-[#1A041E] rounded-[22px] p-4 border border-[#4C1450] shadow-xs space-y-2.5">
            <div className="flex items-center justify-between gap-2 font-heading">
              <span className="inline-flex items-center gap-1.5 text-[10px] font-black uppercase tracking-wider text-white bg-[#240828] px-3 py-1 rounded-full border border-[#FFE600]">
                {progress < 100 ? (
                  <>
            ...
            {/* Progress Bar */}
            <div className="h-2.5 w-full bg-[#2E0832] rounded-full overflow-hidden p-0.5 shadow-inner">
              <div 
            ...
            {/* Diagnostic Message */}
            <p className="text-xs sm:text-sm font-black text-white min-h-[1.5rem] flex items-center justify-center transition-all duration-300 font-heading">
          ...
          {progress >= 25 && (
            <div className="bg-[#1A041E] rounded-[20px] p-4 sm:p-5 border border-[#4C1450] text-left flex items-start gap-3.5 shadow-xs relative overflow-hidden animate-pop">
              <div className="w-10 h-10 rounded-xl bg-[#240828] border border-[#FFE600] flex items-center justify-center text-[#FF2A85] shrink-0 mt-0.5">
              ...
              <div className="space-y-0.5 font-heading">
                ...
                <p className="text-xs text-[#D4BCD0] font-medium">
          ...
          {progress >= 50 && (
            <div className="space-y-2.5 animate-pop">
              <div className="pt-1">
                <span className="text-[11px] font-black uppercase tracking-[0.15em] text-white font-heading">
                  TU EVOLUCIÓN CON EL PROTOCOLO PGB (28 DÍAS)
                </span>
              </div>

              {/* TIMELINE ITEM 1 */}
              <div className="bg-[#1A041E] rounded-2xl p-3.5 border border-[#4C1450] flex items-center justify-between gap-3 text-left shadow-2xs">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-[#240828] border border-[#FFE600] flex items-center justify-center text-lg shrink-0">
                    🔥
                  </div>
              ...
              <div className="bg-[#1A041E] rounded-2xl p-3.5 border border-[#4C1450] flex items-center justify-between gap-3 text-left shadow-2xs">
                <div className="flex items-center gap-3">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs sm:text-sm font-bold text-white">
                      <u className="decoration-[#FFB800] font-black">Mejora de contorno</u> y elevación glútea
                    </p>
                  </div>
                </div>
                <span className="text-xs font-black text-[#FFB800] font-heading">50%</span>
              </div>

              {/* TIMELINE ITEM 3 */}
              <div className="bg-[#1A041E] rounded-2xl p-3.5 border border-[#4C1450] flex items-center justify-between gap-3 text-left shadow-2xs">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-[#063725] border border-[#10B981]/40 flex items-center justify-center text-lg shrink-0">
                    🍑
                  </div>
                  <div className="space-y-0.5">
          ...
          {progress >= 75 && (
            <div className="animate-pop text-white">
          ...
          {progress >= 100 && (
            <div className="space-y-3 pt-1 animate-pop">
              ...
              <div className="flex items-center justify-center gap-2 text-xs font-medium text-[#A890A4]">
