    ...
    <div className="min-h-dvh bg-gradient-to-b from-[#FFF2D6] via-[#FFF5F9] to-[#FFF9F2] py-6 px-3.5 sm:px-6 flex flex-col justify-center items-center font-body text-[#2B0B2E]">
      ...
      <div className="w-full max-w-lg mx-auto space-y-3.5">
        ...
        <div className="text-center">
          <span className="inline-flex items-center gap-1.5 bg-[#FFFBE6] text-[#2B0B2E] border-2 border-[#FFE600] text-xs font-black uppercase tracking-wider px-3.5 py-1 rounded-full shadow-[2px_2px_0px_#FF2A85] font-heading">
        ...
        {/* MAIN CARD CONTAINER */}
        <div className="bg-white rounded-[26px] p-5 sm:p-7 shadow-xl border border-[#FDE2EE] animate-pop space-y-5 text-center quiz-card">
          
          {/* LIVE DIAGNOSTIC LOADER HEADER */}
          <div className="bg-[#FFF4FA] rounded-[22px] p-4 border border-[#FDE2EE] shadow-xs space-y-2.5">
            <div className="flex items-center justify-between gap-2 font-heading">
              <span className="inline-flex items-center gap-1.5 text-[10px] font-black uppercase tracking-wider text-[#2B0B2E] bg-white px-3 py-1 rounded-full border border-[#FFE600]">
                {progress < 100 ? (
                  <>
            ...
            {/* Progress Bar */}
            <div className="h-2.5 w-full bg-[#FDE2EE] rounded-full overflow-hidden p-0.5 shadow-inner">
              <div 
          ...
          {progress >= 25 && (
            <div className="bg-[#FFF4FA] rounded-[20px] p-4 sm:p-5 border border-[#FDE2EE] text-left flex items-start gap-3.5 shadow-xs relative overflow-hidden animate-pop">
              <div className="w-10 h-10 rounded-xl bg-[#FFFBE6] border border-[#FFE600] flex items-center justify-center text-[#FF2A85] shrink-0 mt-0.5">
              ...
              <div className="space-y-0.5 font-heading">
                ...
                <p className="text-xs text-[#6C586B] font-medium">
          ...
          {progress >= 50 && (
            <div className="space-y-2.5 animate-pop">
              ...
              {/* TIMELINE ITEM 1 */}
              <div className="bg-[#FFF4FA] rounded-2xl p-3.5 border border-[#FDE2EE] flex items-center justify-between gap-3 text-left shadow-2xs">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-[#FFFBE6] border border-[#FFE600] flex items-center justify-center text-lg shrink-0">
                    🔥
                  </div>
              ...
              <div className="bg-[#FFF4FA] rounded-2xl p-3.5 border border-[#FDE2EE] flex items-center justify-between gap-3 text-left shadow-2xs">
                <div className="flex items-center gap-3">
                  ...
                  <div className="space-y-0.5">
                    <span className="inline-block bg-[#2B0B2E] text-white font-black text-[10px] px-2.5 py-0.5 rounded-full uppercase tracking-wider font-heading">
                      14 DÍAS
                    </span>
                    <p className="text-xs sm:text-sm font-bold text-[#2B0B2E]">
